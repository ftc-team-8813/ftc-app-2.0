...
public class DriveConstants {
    ...
    private static final double MOTOR_RATIO = (68.0/13.0) * (84.0/29.0); //5:1 and 3:1 ultraplanetary
    public static final double TICKS_PER_REV = 28.0 * MOTOR_RATIO;
    public static final double MAX_RPM = 6000.0 / MOTOR_RATIO;
