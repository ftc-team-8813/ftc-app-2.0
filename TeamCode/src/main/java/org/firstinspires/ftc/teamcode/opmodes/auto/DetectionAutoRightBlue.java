...
@Config
@Autonomous(name = "!!Detection Auto Right Blue!!")

public class DetectionAutoRightBlue extends LoggingOpMode {
        ...
        switch (num) {
            ...
            case 2:
                if(result.equals("right") || result.equals("center")){
                    ...
                    targetPose = new Pose2d(6, -7.5, Rotation2d.fromDegrees(0));
