...
public class Drivetrain {
    ...
    public final DistanceSensor y_dist;

    public Drivetrain(DcMotorEx front_left, DcMotorEx front_right, DcMotorEx back_left, DcMotorEx back_right, IMU imu, DistanceSensor y_dist) {
