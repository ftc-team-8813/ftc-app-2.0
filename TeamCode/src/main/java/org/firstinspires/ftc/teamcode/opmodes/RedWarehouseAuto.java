    ...
    public void loop() {
        ...
        switch (id1){
            case 0: //vision
                ...
                break;
            case 1: //go to goal
                robot.navigation.moveToPosition(0, 25.5, 0.0, 0.55, true);
                break;
            case 2: //go to warehouse, make sure slides are in before bucket goes down
                robot.navigation.moveToPosition(0,-25.0,0.0, 0.7, true);
            ...
            case 3: //intake, once done tell slides to start extending
                ...
                robot.navigation.moveToPosition(0,-31.5,.1,.4,true);
                if (!waiting1) {timer1.reset(); waiting1 = true;}
            ...
            case 8: //outtake and back to warehouse entrance
                robot.intake.setIntakeBack(-0.8);
                robot.navigation.moveToPosition(9,-27.0,0.0, 0.7, true);
            ...
            case 9: //back to goal, wait for scoring before next case
                robot.navigation.moveToPosition(9,37.5,0.0, 0.7, true);
                robot.intake.setIntakeBack(-0.5);
            ...
            case 14: //park
                ...
                robot.navigation.moveToPosition(13,-10,0.0, 0.9, true);
                break;
        }
        //--------------------------------------------------------------------------------------------------------
        //LIFT ---------------------------------------------------------------------------------------------------
        ...
        switch (id2){
            ...
            case 13: //extend slides
                robot.lift.extend(Status.STAGES.get("high") + 1350, true);
                if (auto.lift_reached) id2+=1;
                break;
